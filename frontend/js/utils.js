...
const UI = {
    ...
    fixContentUrls(htmlContent) {
        ...
        const backendUrl = (typeof CONFIG !== 'undefined' && CONFIG.CLIENT_URL) ? CONFIG.CLIENT_URL : (typeof CONFIG !== 'undefined' ? CONFIG.CLIENT_URL : window.location.origin);
...
function setupNewsletter() {
    ...
    if (form) {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            let apiBase = (typeof CONFIG !== 'undefined' ? CONFIG.API_BASE_URL : '/api');
